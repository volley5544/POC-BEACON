...
import 'booth_list_copy_model.dart';
export 'booth_list_copy_model.dart';

class BoothListCopyWidget extends StatefulWidget {
  const BoothListCopyWidget({
    super.key,
    int? eventId,
    this.eventDocRef,
  ...
  static String routeName = 'BoothListCopy';
  static String routePath = '/boothListCopy';

  @override
  State<BoothListCopyWidget> createState() => _BoothListCopyWidgetState();
}

class _BoothListCopyWidgetState extends State<BoothListCopyWidget>
    with TickerProviderStateMixin {
  late BoothListCopyModel _model;
