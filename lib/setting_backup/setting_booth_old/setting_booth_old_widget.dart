...
import 'setting_booth_old_model.dart';
export 'setting_booth_old_model.dart';

class SettingBoothOldWidget extends StatefulWidget {
  const SettingBoothOldWidget({
    super.key,
    this.eventId,
  ...
  static String routeName = 'SettingBoothOld';
  static String routePath = '/settingBoothOld';

  @override
  State<SettingBoothOldWidget> createState() => _SettingBoothOldWidgetState();
}

class _SettingBoothOldWidgetState extends State<SettingBoothOldWidget> {
  late SettingBoothOldModel _model;
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.remindAmountTextController,
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.remindAmountFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
