  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<EventsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventsRecord> eventSelectionEventsRecordList = snapshot.data!;
                      ...
                      Builder(
                        builder: (context) {
                          final eventSelectionVar =
                              eventSelectionEventsRecordList
                                  .where((e) =>
                                      e.endDatetime! >=
                                      _model.datetimeCurrentEnd!)
                                  .toList();
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, eventSelectionVarIndex) {
                              ...
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 12.0, 16.0, 0.0),
                                child: StreamBuilder<List<RegisterRecord>>(
                                  stream: queryRegisterRecord(
                                    parent: eventSelectionVarItem.reference,
                                    queryBuilder: (registerRecord) =>
                                        registerRecord
                                            .where(
                                              'uid',
                                              isEqualTo:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          AutoSizeText(
                                                                            '${dateTimeFormat("d/M/y", eventSelectionVarItem.startDatetime)} (${dateTimeFormat("Hm", eventSelectionVarItem.startDatetime)})'.maybeHandleOverflow(
                                                                              maxChars: 70,
                                                                              replacement: '…',
                                                                            ),
                                                                            textAlign:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          AutoSizeText(
                                                                            '${dateTimeFormat("d/M/y", eventSelectionVarItem.endDatetime)} (${dateTimeFormat("Hm", eventSelectionVarItem.endDatetime)})'.maybeHandleOverflow(
                                                                              maxChars: 70,
                                                                              replacement: '…',
                                                                            ),
                                                                            textAlign:
