...
import 'survey_copy_model.dart';
export 'survey_copy_model.dart';

class SurveyCopyWidget extends StatefulWidget {
  const SurveyCopyWidget({super.key});

  static String routeName = 'SurveyCopy';
  static String routePath = '/surveyCopy';

  @override
  State<SurveyCopyWidget> createState() => _SurveyCopyWidgetState();
}

class _SurveyCopyWidgetState extends State<SurveyCopyWidget>
    with TickerProviderStateMixin {
  late SurveyCopyModel _model;
