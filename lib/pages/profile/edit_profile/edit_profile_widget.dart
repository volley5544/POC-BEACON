                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_photoProfile = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_photoProfile = false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                          selectedMedia.length &&
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_photoProfile =
                                          selectedUploadedFiles.first;
                                  ...
                                  if (_model.passwordConfirmTextController
                                    ...
                                    if (_model.passwordTextController.text ==
                                      ...
                                      context.pushNamedAuth(
                                          SuccessEditProfileWidget.routeName,
                                          context.mounted);
                                    } else {
                                      await showDialog(
                                        context: context,
