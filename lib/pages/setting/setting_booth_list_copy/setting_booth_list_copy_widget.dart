...
import 'setting_booth_list_copy_model.dart';
export 'setting_booth_list_copy_model.dart';

class SettingBoothListCopyWidget extends StatefulWidget {
  const SettingBoothListCopyWidget({
    super.key,
  ...
  static String routeName = 'SettingBoothListCopy';
  static String routePath = '/settingBoothListCopy';

  @override
  State<SettingBoothListCopyWidget> createState() =>
      _SettingBoothListCopyWidgetState();
}

class _SettingBoothListCopyWidgetState
    extends State<SettingBoothListCopyWidget> {
  late SettingBoothListCopyModel _model;
