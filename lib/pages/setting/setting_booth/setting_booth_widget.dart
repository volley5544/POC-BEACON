...
class SettingBoothWidget extends StatefulWidget {
  ...
  @override
  State<SettingBoothWidget> createState() => _SettingBoothWidgetState();
}

class _SettingBoothWidgetState extends State<SettingBoothWidget>
    with TickerProviderStateMixin {
  late SettingBoothModel _model;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    TextFormField(
                                      ...
                                      autofocus: widget.typePage != 'edit',
                                      textCapitalization:
                                                    ...
                                                    return ListView.builder(
                                                      ...
                                                      itemCount:
                                                          firebaseImageList
                                                              .length,
                                                      itemBuilder: (context,
                                                          firebaseImageListIndex) {
                                                        final firebaseImageListItem =
                                                            firebaseImageList[
                                                                firebaseImageListIndex];
                                                        return Padding(
                                                          padding:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            image:
                                                                              ...
                                                                              placeholderBuilder: (_) => SizedBox.expand(
                                                                                child: Image(
                                                                                  image: BlurHashImage('LCPso48Y0h6+_c4U=x+s^*E*00S2'),
                                                                                  fit: BoxFit.cover,
                                                                                ),
                                                                              ),
                                                                              image: NetworkImage(
                                                                                firebaseImageListItem,
                                                                              ),
                                                                              fit: BoxFit.contain,
                                                                            ),
                                                                            allowRotation:
                                    ...
                                    if (_model.uploadImageLocalTemp.length > 0)
                                      Expanded(
                                        child: Container(
                                          width: double.infinity,
                                          height: 120.0,
                                                            ...
                                                            children: [
                                                              ...
                                                              Align(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    _model.removeAtIndexFromUploadImageLocalTemp(
                                                                        uploadImageListIndex);
                                                                    safeSetState(
                                                                        () {});
                                                                  },
